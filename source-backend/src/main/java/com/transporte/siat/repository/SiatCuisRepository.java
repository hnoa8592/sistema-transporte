...
@Repository
public interface SiatCuisRepository extends JpaRepository<SiatCuis, UUID> {

    @Query("""
        SELECT c FROM SiatCuis c
        ...
        LIMIT 1
        """)
    Optional<SiatCuis> findVigente(UUID configId, Integer sucursal, Integer puntoVenta);
}
